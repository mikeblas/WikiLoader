namespace WikiLoaderEngine
{
    public interface IXmlDumpParserProgress
    {
        ...
        /// </summary>
        /// <param name="position">Current offset in to the file, in bytes.</param>
        ...
        /// <param name="usersExist">Number of Contributor users that already existed on this page.</param>
        ...
        /// <summary>
        /// Called when back-pressure prevents something from being enqueued.
        /// </summary>
